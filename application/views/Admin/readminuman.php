...
<div class="wrapper">
    ...
    <div class="main-panel">
		...
		<div class="content">
            <div class="container-fluid">
                <div class="row">
					<h2 style="margin-top:7px; text-align: center">Detail <strong>Data Minuman</strong></h2>
					...
					<h5><?php echo form_open('admin/updateminuman/'.$minuman->ID_MINUMAN); ?>
                    ...
                    Gambar Minuman : <br><img src="<?php echo base_url('assets/upload/'. $minuman->GAMBAR_MINUMAN);?>" alt="" width="200px" height="150px"> <br><br>

                    Icon Minuman : <br><img src="<?php echo base_url('assets/upload/'. $minuman->GAMBAR_TOPPING_MM);?>" alt="" width="100px" height="100px"> <br><br>

					Deskripsi : <br><textarea type="text" class="form-control" name="DESKRIPSI_MINUMAN" readonly><?php echo $minuman->DESKRIPSI_MINUMAN; ?></textarea><br>
		
					Harga : <br><input type="text" class="form-control" name="HARGA_MINUMAN"  value="<?php echo  $minuman->HARGA_MINUMAN;  ?>" readonly><br>

					Stok : <br><input type="number" class="form-control" name="STOK_MINUMAN"  value="<?php echo $minuman->STOK_MINUMAN; ?>" readonly>
