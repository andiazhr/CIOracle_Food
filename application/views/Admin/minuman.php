...
<div class="wrapper">
    ...
    <div class="main-panel">
		...
		<div class="content">
            <div class="container-fluid">
                <div class="row">
						<h2 style="margin-top:7px; text-align:center;">Data <strong>Minuman</strong></h2>
						
						<a href="<?php echo base_url(); ?>admin/addminuman">
						...
						<table class="table table-striped table-hover table-bordered">
								...
								<tr>
									...
									<th style="font-size: 16px;">Gambar Minuman</th>
								...
								<tr>
                                    ...
                                    <td><center><img src="<?php echo base_url('assets/upload/'. $key['GAMBAR_MINUMAN']);?>" alt="" width="200px" height="150px"></center></td>
									<td><center><img src="<?php echo base_url('assets/upload/'. $key['GAMBAR_TOPPING_MM']);?>" alt="" width="100px" height="100px"></center></td>
									<td><?php echo $key['DESKRIPSI_MINUMAN'] ?></td>
									<td><?php echo number_format($key['HARGA_MINUMAN']) ?></td>
									<td><?php echo $key['STOK_MINUMAN'] ?></td>

									<td>
										<a href="<?php echo base_url() ?>admin/readminuman/<?php echo $key['ID_MINUMAN'] ?>"><button class="btn btn-info">Detail </button></a> <br><br>
										<a href="<?php echo base_url() ?>admin/updateminuman/<?php echo $key['ID_MINUMAN'] ?>"><button class="btn btn-primary">Edit</button></a> <br><br>
										<a href="<?php echo base_url() ?>admin/deleteminuman/<?php echo $key['ID_MINUMAN'] ?>"><button class="btn btn-danger" onClick="return confirm('apakah anda ingin menghapus data ?')">Hapus</button></a>
    ...
    document.getElementById("hasil").innerHTML = "<?php echo $stok_minuman ?>";
	});
	</script>
