...
<div class="wrapper">
    ...
    <div class="main-panel">
		...
		<div class="content">
            <div class="container-fluid">
                <div class="row">
					<h2 style="text-align: center; margin-top:7px;">Tambah <strong>Data Minuman</strong></h2>
					<form action="<?php echo base_url(); ?>admin/add_minuman" method="post" enctype="multipart/form-data">
						<h5>
                            Nama Minuman : <br><input type="text" class="form-control" name="NAMA_MINUMAN" placeholder="Masukkan Nama Minuman"><br>

							Gambar Minuman: <br><input type="file" name="GAMBAR_MINUMAN" placeholder="Masukkan Gambar"><br>

                            Icon: <br><input type="file" name="GAMBAR_TOPPING_MM" placeholder="Masukkan Gambar"><br>

							Deskripsi : <br><textarea type="text" minlength=100 maxlength="170" class="form-control" name="DESKRIPSI_MINUMAN" placeholder="Masukkan Deskripsi"></textarea><br>
		
							Harga : <br><input type="number" class="form-control" name="HARGA_MINUMAN" placeholder="Masukkan Harga"><br>

							Stok : <br><input type="number" class="form-control" name="STOK_MINUMAN" placeholder="Masukkan Stok"><br>
