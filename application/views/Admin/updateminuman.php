...
<div class="wrapper">
    ...
    <div class="main-panel">
		...
		<div class="content">
            <div class="container-fluid">
                <div class="row">
					<h2 style="margin-top:7px;text-align: center">Edit <strong>Data Minuman</strong></h2>
					<center><h5 style="margin-top: -0.5%;"><a href="<?php echo site_url('admin/minuman'); ?> "><img src="<?php echo base_url('assets/images/home.png')?>" alt="" style="margin-top: -1%;" height="25" width="25"/> Home</a></h5></center>
	
					<h5><?php echo form_open_multipart('admin/updateminuman/'.$minuman->ID_MINUMAN); ?>
					ID Minuman : <br><input type="text" class="form-control" name="ID_MINUMAN" value="<?php echo $minuman->ID_MINUMAN; ?>" readonly><br>

					Nama Minuman : <br><input type="text" class="form-control" name="NAMA_MINUMAN" value="<?php echo $minuman->NAMA_MINUMAN; ?>"><br>
		
                    <img src="<?php echo base_url('assets/upload/'. $minuman->GAMBAR_MINUMAN);?>" alt="" width="200px" height="150px"> <br>

					Gambar Minuman : <br><input type="file" name="GAMBAR_MINUMAN"  value="<?php echo  $minuman->GAMBAR_MINUMAN;  ?>"><br>
		
                    <img src="<?php echo base_url('assets/upload/'. $minuman->GAMBAR_TOPPING_MM);?>" alt="" width="100px" height="100px"><br>

                    Icon : <br><input type="file" name="GAMBAR_TOPPING_MM"  value="<?php echo  $minuman->GAMBAR_TOPPING_MM;  ?>"><br>

					Deskripsi : <br><textarea type="text" minlength=100 maxlength="170" class="form-control" name="DESKRIPSI_MINUMAN"><?php echo $minuman->DESKRIPSI_MINUMAN; ?></textarea><br>
		
					Harga : <br><input type="text" class="form-control" name="HARGA_MINUMAN"  value="<?php echo  $minuman->HARGA_MINUMAN;  ?>"><br>

					Stok : <br><input type="number" class="form-control" name="STOK_MINUMAN"  value="<?php echo $minuman->STOK_MINUMAN; ?>">

					<br>
					<?php echo form_submit('submit', 'Update', 'class="btn btn-primary"'); ?>
					<?php echo form_close(); ?>	</h5>
                </div>
            </div>
        </div>
