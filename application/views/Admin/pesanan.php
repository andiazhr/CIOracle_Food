...
<div class="wrapper">
    ...
    <div class="main-panel">
		...
		<div class="content">
            <div class="container-fluid">
                <div class="row">
						<h2 style="margin-top:7px; text-align:center;">Data <strong>Pesanan</strong></h2>
						<button class="btn btn-danger" id="stok" style="margin-top:-7px; margin-bottom:15px; margin-left:320px; text-align:center; float: left;">Hitung Pendapatan Hari Ini</button>
						<p id="hasil" style="margin-left: 20px; float:left"></p>
						<table class="table table-striped table-hover table-bordered">
								<?php $nomor=1; ?>
								<tr>
									<th style="font-size: 16px;">No</th>
									<th style="font-size: 16px;">Nama Pelanggan</th>
									<th style="font-size: 16px;">No Hp</th>
									<th style="font-size: 16px;">Tanggal Pembelian</th>
									<th style="font-size: 16px;">Alamat</th>
									<th style="font-size: 16px;">Nama Makanan</th>
									<th style="font-size: 16px;">Harga Makanan</th>
									<th style="font-size: 16px;">Jumlah Beli Makanan</th>
									<th style="font-size: 16px;">Nama Minuman</th>
									<th style="font-size: 16px;">Harga Minuman</th>
									<th style="font-size: 16px;">Jumlah Beli Minuman</th>
									<th style="font-size: 16px;">Total Pembelian</th>
									<th style="font-size: 16px;">Action</th>

								</tr>
								<?php foreach ($pesanan->result_array() as $key): ?>
								<tr>
									<td><?php echo $nomor; ?></td>
									<td><?php echo $key['NAMA_PELANGGAN'] ?></td> 
									<td><?php echo $key['NO_HP_PELANGGAN'] ?></td>
									...
									<td><?php echo $key['JUMBEL_MAKANAN'] ?></td> 
									<td><?php echo $key['NAMA_MINUMAN'] ?></td>
									<td><?php echo number_format($key['HARGA_MINUMAN']) ?></td>
									<td><?php echo $key['JUMBEL_MINUMAN'] ?></td>
									<td><?php echo number_format(($key['HARGA_MAKANAN']*$key['JUMBEL_MAKANAN'])+($key['HARGA_MINUMAN']*$key['JUMBEL_MINUMAN'])) ?></td>

									<td>
										<a href="<?php echo base_url() ?>admin/readpesanan/<?php echo $key['ID_PESANAN'] ?>"><button class="btn btn-info">Detail </button></a> <br><br>
										<a href="<?php echo base_url() ?>admin/deletepesanan/<?php echo $key['ID_PESANAN'] ?>"><button class="btn btn-danger" onClick="return confirm('apakah anda ingin menghapus data ?')">Hapus</button></a>
    ...
    document.getElementById("hasil").innerHTML = "<?php echo number_format($total_pendapatan) ?>";
	});
	</script>
