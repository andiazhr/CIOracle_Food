...
<div class="wrapper">
    ...
    <div class="main-panel">
		...
		<div class="content">
            <div class="container-fluid">
                <div class="row">
					<h2 style="margin-top:7px;text-align: center">Edit <strong>Data Makanan</strong></h2>
					...
					<h5><?php echo form_open_multipart('admin/updatemakanan/'.$makanan->ID_MAKANAN); ?>
					ID Makanan : <br><input type="text" class="form-control" name="ID_MAKANAN" value="<?php echo $makanan->ID_MAKANAN; ?>" readonly><br>

					Nama Makanan : <br><input type="text" class="form-control" name="NAMA_MAKANAN" value="<?php echo $makanan->NAMA_MAKANAN; ?>"><br>

					Topping : <br><input type="text" class="form-control" name="TOPPING" value="<?php echo $makanan->TOPPING; ?>"><br>
		
                    <img src="<?php echo base_url('assets/upload/'. $makanan->GAMBAR_MAKANAN);?>" alt="" width="200px" height="150px"> <br>

					Gambar Makanan: <br><input type="file" name="GAMBAR_MAKANAN"  value="<?php echo  $makanan->GAMBAR_MAKANAN;  ?>"><br>

                    <img src="<?php echo base_url('assets/upload/'. $makanan->ICON_MK);?>" alt="" width="100px" height="100px"><br>

					Icon : <br><input type="file" name="ICON_MK"  value="<?php echo  $makanan->ICON_MK;  ?>"><br>

					Deskripsi : <br><textarea type="text" minlength=100 maxlength="170" class="form-control" name="DESKRIPSI_MAKANAN"><?php echo $makanan->DESKRIPSI_MAKANAN; ?></textarea><br>
		
					Harga : <br><input type="text" class="form-control" name="HARGA_MAKANAN"  value="<?php echo  $makanan->HARGA_MAKANAN;  ?>"><br>

					Stok : <br><input type="number" class="form-control" name="STOK_MAKANAN"  value="<?php echo $makanan->STOK_MAKANAN; ?>">
